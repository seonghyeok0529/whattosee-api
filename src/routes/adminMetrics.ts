...
const KO_STOPWORDS = new Set([
  ...
  "하는","했다","한다","됐다","된다","있다","없다","위해","중","더","또","플레이",
   "라이브","생중계","생방송", "속보", "2025년", "2026년","채널a","굿모닝","이슈","업무보고","권고","국힘","민주당",
  "뉴스투데이","뉴스a","뉴스9","뉴스데스크","뉴스룸","8뉴스","뉴스특보","날씨",
  "12월","1월","2월","3월","4월","5월","6월","7월","8월","9월","10월","11월",
   "1일","2일","3일","4일","5일","6일","7일","8일","9일","10일",
  "11일","12일","13일","14일","15일","16일","17일","18일","19일","20일",
  "21일","22일","23일","24일","25일","26일","27일","28일","29일","30일","31일",
   "돌로","대통령","아침","저녁","만에","와글와글","검토","국회","징계","법원",
   "경찰","자막뉴스","mbc뉴스","경찰","수사","현장영상","의혹","재판","특검",
   "민주","중징계",
]);
...
const EN_STOPWORDS = new Set([
  ...
  "is","are","was","were","be","been","it","this","that","these","those",
   "live","breaking","news","shorts",
  "ytn","kbs","mbc","sbs","mbn","jtbc","channela","tv",
]);
